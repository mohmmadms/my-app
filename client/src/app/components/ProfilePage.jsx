...
const ProfilePage = () => {
  ...
  return (
    <>
      ...
      {profileData && (
        <>
          <div className="sm:flex xl:block sm:space-x-4 xl:space-x-0 dark:bg-black p-4 rounded-lg">
            <img
            ...
            />
            <div>
              <h2 className="text-xl font-bold dark:text-gray-200">{profileData.Name}</h2>
              <ul className="mt-2 space-y-1">
                <li className="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
                  <svg
                    className="mr-2 w-4 h-4 text-gray-900 dark:text-gray-400"
                    fill="currentColor"
                    viewBox="0 0 20 20"
          ...
          <div className="mb-4 sm:flex xl:block dark:bg-black p-4 rounded-lg">
            <div className="sm:flex-1">
              <address className="text-sm not-italic font-normal text-gray-500 dark:text-gray-400">
                ...
                <a className="text-sm font-medium text-gray-900 dark:text-gray-200" href={`mailto:${profileData.Email}`}>
                  {profileData.Email}
                </a>
                <div className="mt-4">Phone number</div>
                <div className="mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">
                  {profileData.phoneNumber || 'Not specified'}
                </div>
              </address>
            </div>
          </div>
          <div className="dark:bg-black p-4 rounded-lg">
            <h3 className="mb-2 text-base font-bold text-gray-900 dark:text-gray-200">Personal Information</h3>
            <ul className="space-y-2">
              <li className="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
                <span className="mr-2 font-semibold dark:text-gray-300">Nationality:</span>
