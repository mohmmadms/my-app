  ...
  return (
    <>
      ...
      >
        ...
        <img
        src= {profileImage ? `http://localhost:3001/${profileImage}` : "/profile.png"}
        alt="Profile Picture"
        ...
        <ul className="mt-6">
          ...
          {/* Logout Link */}
          {isAuthenticated && (
            <li className="absolute bottom-0 left-0 mb-4">
              <Logout/>
            </li>
          )}
            ...
            <li className="mb-4">
              <Link href="/dashboard" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                <svg className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                  ...
                  <path d="M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0 11 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565                  A8.51 8.51 0 0 0 12.5 0Z"/>
                  </svg>
          ...
          <li className="mb-4">
            <Link href="/courses" className="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
