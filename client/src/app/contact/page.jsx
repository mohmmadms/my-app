        ...
        <div className="lg:w-1/2 md:w-2/3 mx-auto">
          <div className="flex flex-wrap -m-2">
            ...
            <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
              <a className="text-indigo-500 leading-normal my-5" href="mailto:mohmmadmms20@gmail.com">mohmmadmms20@gmail.com</a>
              <p className="leading-normal my-5 dark:text-white">
                Jordan.<br />
                Amman
              </p>
              <span className="inline-flex">
                <a className="ml-4 text-gray-500" href="https://twitter.com">
